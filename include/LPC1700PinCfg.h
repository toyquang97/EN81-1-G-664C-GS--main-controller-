...
#define P0_15_TXD1            0x01ul                                      /* UART1发送引脚                */
#define P0_15_SCK0            0x02ul                                      /* SSP0时钟线                   */
#define P0_15_SCK             0x03ul                                      /* SPI时钟线                    */
...
#define P0_16_RXD1            0x01ul                                      /* UART1接收引脚                */
#define P0_16_SSEL0           0x02ul                                      /* SSP0从机选择                 */
#define P0_16_SSEL            0x03ul                                      /* SPI从机选择                  */
...
#define P0_18_DCD1            0x01ul                                      /* UART1数据载波检测输入DCD     */
#define P0_18_MOSI0           0x02ul                                      /* SSP-0主输出从输入数据线      */
#define P0_18_MOSI            0x03ul                                      /* SPI主出从入数据线            */
...
#define P0_20_DTR1            0x01ul                                      /* UART1终端就绪DTR             */
//...   Reserved              0x02ul                                  	/* 保留                         */
#define P0_20_SCL1            0x03ul                                      /* I2C-1时钟线（非开漏）        */
...
#define P0_21_RI1             0x01ul                                      /* UART1振铃信号                */
//...   Reserved              0x02ul                                      /* 保留                         */
#define P0_21_RD1             0x03ul                                      /* CAN-1接收引脚                */
...
#define P0_22_RTS1            0x01ul                                      /* UART1请求发送引脚            */
//...   Reserved              0x02ul                                      /* 保留                         */
#define P0_22_TD1             0x03ul                                      /* CAN-1发送线                  */
...
#define P0_23_AD00            0x01ul                                      /* ADC-0，通道0                 */
#define P0_23_I2SRX_CLK       0x02ul                                      /* I2S接收时钟SCK               */
#define P0_23_CAP30           0x03ul                                      /* 定时器3捕获输入，通道0       */
...
#define P0_24_AD01            0x01ul                                      /* ADC-0，通道1                 */
#define P0_24_I2SRX_WS        0x02ul                                      /* I2S接收字选择WS              */
#define P0_24_CAP31           0x03ul                                      /* 定时器3捕获输入，通道1       */
...
#define P0_25_AD02            0x01ul                                      /* ADC-0，通道2                 */
#define P0_25_I2SRX_SDA       0x02ul                                      /* I2S接收数据SD                */
#define P0_25_TXD3            0x03ul                                      /* UART3发送引脚                */
...
#define P0_26_AD03            0x01ul                                      /* ADC-0，通道3                 */
#define P0_26_AOUT            0x02ul                                      /* DAC输出                      */
#define P0_26_RXD3            0x03ul                                      /* UART-3接收引脚               */
...
#define P0_27_SDA0            0x01ul                                      /* I2C0数据输入/输出，开漏      */
#define P0_27_USB_SDA         0x02ul                                      /* USB接口I2C串行数据OTG收发器  */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P0_28_SCL0            0x01ul                                      /* I2C0时钟输入，开漏           */
#define P0_28_USB_SCL         0x02ul                                      /* USB接口I2C时钟线，OTG收发器  */
//..    Reserved              0x03ul                                   /* 保留                         */
...
#define P0_29_USB_DD          0x01ul                                      /* USB双向数据D+线              */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P0_30_USB_DS          0x01ul                                      /* USB双向数据D-线              */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_0_ENET_TXD0        0x01ul                                      /* 以太网发送数据脚0            */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_1_ENET_TX_EN       0x01ul                                      /* 以太网发送数据脚1            */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_4_ENET_TX_EN       0x01ul                                      /* 以太网发送使能               */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_8_ENET_CRS         0x01ul                                      /* 以太网载波侦测脚             */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_9_ENET_RXD0        0x01ul                                      /* 以太网接收数据脚0            */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_10_ENET_RXD1       0x01ul                                      /* 以太网接收数据脚1            */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_14_ENET_RX_ER      0x01ul                                      /* 以太网接收错误               */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_15_ENET_REF_CLK    0x01ul                                      /* 以太网参拷时钟输入           */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_16_ENET_MDC        0x01ul                                      /* 以太网MIIM时钟               */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_17_ENET_MDIO       0x01ul                                      /* 以太网MI数据输入\输出        */
//..    Reserved              0x02ul                                      /* 保留                         */
//..    Reserved              0x03ul                                      /* 保留                         */
...
#define P1_18_USB_UP_LED      0x01ul                                      /* USB GOODLINK指示脚           */
#define P1_18_PWM11           0x02ul                                      /* PWM1输出，通道1              */
#define P1_18_CAP10           0x03ul                                      /* Timer1捕获输入，通道0        */
...
#define P1_19_MCO0A           0x01ul                                      /* 电机控制PWM通道0，输出A      */
#define P1_19_USB_PPWR        0x02ul                                      /* USB端口电源使能信号          */
#define P1_19_CAP11           0x03ul                                      /* Timer1捕获输入，通道1        */
...
#define P1_20_MCFB0           0x01ul                                      /* 电机控制PWM通道0，回环输入   */
#define P1_20_PWM12           0x02ul                                      /* PWM-2输出，通道2             */
#define P1_20_SCK0            0x03ul                                      /* SSP-0时钟输入                */
...
#define P1_21_MCABORT         0x01ul                                      /* 电机控制PWM，紧急中止        */
#define P1_21_PWM13           0x02ul                                      /* PWM-1输出，通道3             */
#define P1_21_SSEL0           0x03ul                                      /* SSP-0从机选择                */
...
#define P1_22_MC0B            0x01ul                                      /* 电机控制PWM通道0，输出B      */
#define P1_22_USB_PWRD        0x02ul                                      /* USB端口的电源状态            */
#define P1_22_MAT10           0x03ul                                      /* 定时器1匹配输出，通道0       */
...
#define P1_23_MCFB1           0x01ul                                      /* 电机控制PWM通道1，反馈输入   */
#define P1_23_PWM14           0x02ul                                      /* PWM-1输出，通道4             */
#define P1_23_MISO0           0x03ul                                      /* SSP-0主机输入，从机输出      */
...
#define P1_24_MCFB2           0x01ul                                      /* 电机控制PWM通道2，反馈输入   */
#define P1_24_PWM15           0x02ul                                      /* PWM-1输出，通道5             */
#define P1_24_MOSI0           0x03ul                                      /* SSP-0主机输出，从机输入      */
...
#define P1_25_MC1A            0x01ul                                      /* 电机控制PWM通道1，输出A      */
#define P1_25_CLKOUT          0x02ul                                      /* 时钟输出引脚                 */
#define P1_25_MAT11           0x03ul                                      /* 定时器1匹配输出，通道1       */
...
#define P1_26_MC1B            0x01ul                                      /* 电机控制PWM通道1，输出B      */
#define P1_26_PWM16           0x02ul                                      /* PWM-1输出，通道6             */
#define P1_26_CAP00           0x03ul                                      /* 定时器0捕获输入，通道0       */
...
#define P1_27_CLKOUT          0x01ul                                      /* 时钟输出引脚                 */
#define P1_27_USB_OVRCR       0x02ul                                      /* USB端口过载电流状态          */
#define P1_27_CAP01           0x03ul                                      /* 定时器0捕获输入，通道1       */
...
#define P1_28_MC2A            0x01ul                                      /* 电机控制PWM通道2，输出A      */
#define P1_28_PCAP10          0x02ul                                      /* PWM-1捕获输入，通道0         */
#define P1_28_MAT00           0x03ul                                      /* 定时器0匹配输出，通道0       */
...
#define P1_29_MC2B            0x01ul                                      /* 电机控制PWM通道2，输出B      */
#define P1_29_PCAP11          0x02ul                                      /* PWM-1捕获输入，通道1         */
#define P1_29_MAT01           0x03ul                                      /* 定时器0匹配输出，通道1       */
...
//...   Reserved              0x01ul                                      /* 保留                         */
#define P1_30_VBUS            0x02ul                                      /* 存在的USB总线电源            */
#define P1_30_AD04            0x03ul                                      /* ADC转换器0.通道4输入         */
...
//...   Reserved              0x01ul                                      /* 保留                         */
#define P1_31_SSCK1           0x02ul                                      /* SSP-1时钟线                  */
#define P1_31_AD05            0x03ul                                      /* ADC-0输入，通道5             */
...
#define P2_0_PWM11            0x01ul                                      /* PWM-1，通道1                 */
#define P2_0_TXD1             0x02ul                                      /* UART1数据发送引脚            */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_1_PWM12            0x01ul                                      /* PWM-1，通道2                 */
#define P2_1_RXD1             0x02ul                                      /* UART1数据接收引脚            */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_2_PWM13            0x01ul                                      /* PWM-1，通道3                 */
#define P2_2_CTS1             0x02ul                                      /* UART1清零发送线              */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_3_PWM14            0x01ul                                      /* PWM-1，通道4                 */
#define P2_3_DCD1             0x02ul                                      /* UART1数据载波检测线          */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_4_PWM15            0x01ul                                      /* PWM-1，通道5                 */
#define P2_4_DSR1             0x02ul                                      /* UART1数据设置就绪线          */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_5_PWM16            0x01ul                                      /* PWM-1，通道6                 */
#define P2_5_DTR1             0x02ul                                      /* UART1数据终端就绪线          */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_6_PCAP10           0x01ul                                      /* PWM-1捕获输入，通道0         */
#define P2_6_RI1              0x02ul                                      /* UART1振铃输入                */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_7_RD2              0x01ul                                      /* CAN-2接收线                  */
#define P2_7_RTS1             0x02ul                                      /* UART1请求发送输出            */
...
#define P2_8_TD2              0x01ul                                      /* CAN-2发送线                  */
#define P2_8_TXD2             0x02ul                                      /* UART2发送引脚                */
#define P2_8_ENET_MDC         0x03ul                                      /* 以太网MIIM时钟               */
...
#define P2_9_U1CONNECT        0x01ul                                      /* USB1软连接控制               */
#define P2_9_RXD2             0x02ul                                      /* UART2接收引脚                */
#define P2_9_ENET_MDIO        0x03ul                                      /* 以太网MIIM数据输入和输出     */
...
#define P2_10_EINT0           0x01ul                                      /* 外部中断0输入                */
#define P2_10_NMI             0x02ul                                      /* 非屏蔽中断输入               */
//...   Reserved              0x03ul                                      /* 保留                         */
...
#define P2_11_EINT1           0x01ul                                      /* 外部中断1输入                */
//...   Reserved              0x02ul                                      /* 保留                         */
#define P2_11_I2STX_CLK       0x03ul                                      /* I2S发送时钟SCK               */
...
#define P2_12_EINT2           0x01ul                                      /* 外部中断2输入                */
//...   Reserved              0x02ul                                      /* 保留                         */
#define P2_12_I2STX_WS        0x03ul                                      /* I2S发送字选择WS              */
...
#define P2_13_EINT3           0x01ul                                      /* 外部中断3输入                */
//...   Reserved              0x02ul                                      /* 保留                         */
#define P2_13_I2STX_SDA       0x03ul                                      /* I2S发送数据SD                */
...
//...   Reserved              0x01ul                                      /*  保留                        */
#define P3_25_MAT00           0x02ul                                      /*  定时器0匹配输出，通道0      */
#define P3_25_PWM12           0x03ul                                      /*  PWM-1输出，通道2            */
...
#define P3_26_STCLK           0x01ul                                      /* 系统节拍定时器时钟输入       */
#define P3_26_MAT01           0x02ul                                      /* 定时器0匹配输出，通道1       */
#define P3_26_PWM13           0x03ul                                      /* PWM-1输出，通道3             */
...
#define P4_28_RX_MCLK         0x01ul                                      /* —I2S接收主机时钟            */
#define P4_28_MAT20           0x02ul                                      /* 定时器2匹配输出，通道0       */
#define P4_28_TXD3            0x03ul                                      /* UART3发送引脚                */
...
#define P4_29_TX_MCLK         0x01ul                                      /* I2S发送主机时钟              */
#define P4_29_MAT21           0x02ul                                      /* 定时器2匹配输出，通道1       */
#define P4_29_RXD3            0x03ul                                      /* UART3接收引脚                */
 ...
 *  bit[3]
 */
#define TPIU_Disable          0x00ul                                     /* TPIU interface 禁止          */
#define TPIU_Enable           0x80ul                                     /* TPIU interface 使能          */
...
** 引脚内部上下拉电阻配置
*********************************************************************************************************/
#define PIN_PULL_UP           0x00ul                                      /* 引脚内部上拉                 */
#define PIN_REPEATER          0x01ul                                      /* 引脚内部上拉                 */
#define PIN_NO_PULL           0x02ul                                      /* 引脚既不上拉，也不下拉       */
#define PIN_PULL_DOWN         0x03ul                                      /* 引脚内部下拉                 */
...
** 外设控制位在PCONP中定义
*********************************************************************************************************/
#define PCTIM0_Enable         1ul                                         /* 禁止定时器/计数器0功率/时钟  */
#define PCTIM0_Disable        0ul                                         /* 使能定时器/计数器0功率/时钟  */
#define PCTIM0_FUNC           PCTIM0_Enable

#define PCTIM1_Enable         1ul                                         /* 禁止定时器/计数器1功率/时钟  */
#define PCTIM1_Disable        0ul                                         /* 禁止定时器/计数器1功率/时钟	*/
#define PCTIM1_FUNC           PCTIM1_Enable

#define PCUART0_Enable        1ul                                         /* 使能UART0功率/时钟控制位     */
#define PCUART0_Disable       0ul                                         /* 禁止UART0功率/时钟控制位     */
#define PCUART0_FUNC          PCUART0_Enable

#define PCUART1_Enable        1ul                                         /* 使能UART1功率/时钟控制位	    */
#define PCUART1_Disable       0ul                                         /* 禁止UART1功率/时钟控制位     */
#define PCUART1_FUNC          PCUART0_Disable

#define PWM1_Enable           1ul                                         /* 使能PWM1功率/时钟控制位      */
#define PWM1_Disable          0ul                                         /* 禁止PWM1功率/时钟控制位      */
#define PWM1_FUNC             PWM1_Disable

#define PCI2C0_Enable         1ul                                         /* 使能I2C0接口功率/时钟控制位  */
#define PCI2C0_Disable        0ul                                         /* 禁止I2C0接口功率/时钟控制位  */
#define PCI2C0_FUNC           PCI2C0_Enable

#define PCSPI_Enable          1ul                                         /* 使能SPI接口功率/时钟控制位	*/
#define PCSPI_Disable         0ul                                         /* 禁止SPI接口功率/时钟控制位   */
#define PCSPI_FUNC            PCSPI_Disable

#define PCRTC_Enable          1ul                                         /* 使能RTC功率/时钟控制位       */
#define PCRTC_Disable         0ul                                         /* 禁止RTC功率/时钟控制位       */
#define PCRTC_FUNC            PCRTC_Disable

#define PCSSP1_Enable         1ul                                         /* 使能SSP1接口功率/时钟控制位  */
#define PCSSP1_Disable        0ul                                         /* 禁止SSP1接口功率/时钟控制位  */
#define PCSSP1_FUNC           PCSSP1_Enable

#define PCAD_Enable           1ul                                         /* 使能A/D转换器功率/时钟控制位 */
#define PCAD_Disable          0ul                                         /* 禁止A/D转换器功率/时钟控制位 */
#define PCAD_FUNC             PCAD_Enable

#define PCCAN1_Enable         1ul                                         /* 使能CAN控制器1功率/时钟控制位*/
#define PCCAN1_Disable        0ul                                         /* 禁止CAN控制器1功率/时钟控制位*/
#define PCCAN1_FUNC           PCCAN1_Enable

#define PCCAN2_Enable         1ul                                         /* 使能CAN控制器2功率/时钟控制位*/
#define PCCAN2_Disable        0ul                                         /* 禁止CAN控制器2功率/时钟控制位*/
#define PCCAN2_FUNC           PCCAN2_Enable

#define PCGPIO_Enable         1ul                                         /* 使能GPIO	                    */
#define PCGPIO_Disable        0ul                                         /* 禁止GPIO                 	*/
#define PCGPIO_FUNC           PCGPIO_Enable

#define PCRIT_Enable          1ul                                         /* 使能重复中断定时器		    */
                                                                        /* 功率/时钟控制位              */
#define PCRIT_Disable         0ul                                         /* 禁止重复中断定时器           */
                                                                        /* 功率/时钟控制位	            */
#define PCRIT_FUNC            PCRIT_Disable

#define PCMC_Enable           1ul                                         /* 使能电机控制PWM              */
#define PCMC_Disable          0ul                                         /* 禁止电机控制PWM              */
#define PCMC_FUNC             PCMC_Disable

#define PCQEI_Enable          1ul                                         /* 使能正交编码器接口           */
                                                                        /* 功率/时钟控制位              */
#define PCQEI_Disable         0ul                                         /* 禁止正交编码器接口           */
                                                                        /* 功率/时钟控制位              */
#define PCQEI_FUNC            PCQEI_Disable

#define PCI2C1_Enable         1ul                                         /* 使能I2C1接口功率/时钟控制位  */
#define PCI2C1_Disable        0ul                                         /* 禁止I2C1接口功率/时钟控制位  */
#define PCI2C1_FUNC           PCI2C1_Disable

#define PCSSP0_Enable         1ul                                         /* 使能SSP0接口功率/时钟控制位  */
#define PCSSP0_Disable        0ul                                         /* 禁止SSP0接口功率/时钟控制位  */
#define PCSSP0_FUNC           PCSSP0_Enable

#define PCTIM2_Enable         1ul                                         /* 使能定时器2功率/时钟控制位   */
#define PCTIM2_Disable        0ul                                         /* 禁止定时器2功率/时钟控制位	*/
#define PCTIM2_FUNC           PCTIM2_Enable

#define PCTIM3_Enable         1ul                                         /* 使能定时器3功率/时钟控制位   */
#define PCTIM3_Disable        0ul                                         /* 禁止定时器3功率/时钟控制位   */
#define PCTIM3_FUNC           PCTIM3_Enable

#define PCUART2_Enable        1ul                                         /* 使能UART2功率/时钟控制位	    */
#define PCUART2_Disable       0ul                                         /* 禁止UART2功率/时钟控制位	    */
#define PCUART2_FUNC          PCUART2_Disable

#define PCUART3_Enable        1ul                                         /* 使能UART3功率/时钟控制位	    */
#define PCUART3_Disable       0ul                                         /* 禁止UART3功率/时钟控制位	    */
#define PCUART3_FUNC          PCUART3_Disable

#define PCI2C2_Enable         1ul                                         /* 使能I2C接口2功率/时钟控制位  */
#define PCI2C2_Disable        0ul                                         /* 禁止I2C接口2功率/时钟控制位	*/
#define PCI2C2_FUNC           PCI2C2_Disable

#define PCI2S_Enable          1ul                                         /* 使能I2S接口功率/时钟控制位   */
#define PCI2S_Disable         0ul                                         /* 禁止I2S接口功率/时钟控制位   */
#define PCI2S_FUNC            PCI2S_Disable

#define PCGPDMA_Enable        1ul                                         /* 使能GP DMA功能功率/时钟控制位*/
#define PCGPDMA_Disable       0ul                                         /* 禁止GP DMA功能功率/时钟控制位*/
#define PCGPDMA_FUNC          PCGPDMA_Disable

#define PCENET_Enable         1ul                                         /* 使能以太网模块功率/时钟控制位*/
#define PCENET_Disable        0ul                                         /* 禁止以太网模块功率/时钟控制位*/
#define PCENET_FUNC           PCENET_Disable

#define PCUSB_Enable          1ul                                         /* 使能USB接口功率/时钟控制位   */
#define PCUSB_Disable         0ul                                         /* 禁止USB接口功率/时钟控制位	*/
