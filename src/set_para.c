...
// P0 General parameter
	...
	p.doorzoneswitchsize = 225;			// 默认卡板长度225mm(实际约300mm)
	p.exe_number = 1;				//默认情况下有1个扩展板，用于控制柜
...
// PR12 auto-call func.
	...
	p.cooperate_sel1 = 16;//COOP_INSP_RETURN
	p.cooperate_sel2 = 0;
...
// F5 parameter
	...
	p.hse_ex_outpar [0][IO_BASIC_FUNC] = FIRE_FUNCTION;
	...
	for (i = 1; i < 3; i++)
		{
			if(i == 1)
				{
					exe_para.exe_inpar [i][0][IO_BASIC_FUNC] = DOORTEST;
					exe_para.exe_inpar [i][0][IO_ENABLE] = ENABLE;
					exe_para.exe_inpar [i][0][IO_STATE] = POLARITY_BIT;			
					exe_para.exe_inpar [i][1][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][1][IO_SUB_FUNC] = INSP_PITBOX_UP;
					exe_para.exe_inpar [i][1][IO_ENABLE] = ENABLE;
					exe_para.exe_inpar [i][2][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][2][IO_SUB_FUNC] = INSP_PITBOX_DOWN;
					exe_para.exe_inpar [i][2][IO_ENABLE] = ENABLE;
					exe_para.exe_inpar [i][3][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][3][IO_SUB_FUNC] = INSP_PITBOX_ON;
					exe_para.exe_inpar [i][3][IO_ENABLE] = ENABLE;
				}
			else
				{
					exe_para.exe_inpar [i][0][IO_BASIC_FUNC] = DOORTEST;
					...
					exe_para.exe_inpar [i][0][IO_STATE] = POLARITY_BIT; 		
					exe_para.exe_inpar [i][1][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][1][IO_SUB_FUNC] = INSP_PLATFORM_UP;
					exe_para.exe_inpar [i][1][IO_ENABLE] = ENABLE;
					exe_para.exe_inpar [i][2][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][2][IO_SUB_FUNC] = INSP_PLATFORM_DOWN;
					exe_para.exe_inpar [i][2][IO_ENABLE] = ENABLE;
					exe_para.exe_inpar [i][3][IO_BASIC_FUNC] = INSPECT_IN;
					exe_para.exe_inpar [i][3][IO_SUB_FUNC] = INSP_PLATFORM_ON;
					exe_para.exe_inpar [i][3][IO_ENABLE] = ENABLE;
				}
		}
