...
#define MAX_ESE_PER_F_D		3					//ÿ��ÿ��������Ӧ��ese����
...
//���� bFunc_flag ��λ����
#define	FUNC_MSI_CHANGE				0x01		//�����źű仯
#define	FUNC_DOORSTOP_TIMEOUT	0x02		//��ʱ���Ű�ťʱ�䵽
#define	FUNC_ARRIVEGONG_TIMEIN	0x04		//��վ��ҹ��ʱ�䵽
#define	FUNC_FIRE_DOORCLOSE			0x10		//���������е�ʱ�䵽
#define	FUNC_OVERSPEEP_ACTIVE		0x40	//��վ���ٱ�־
#define	FUNC_CANA_INIT					0x80	//CANA ��ʼ����־
#define	FUNC_CANA_ERROR				0x100	//CANA �����־
#define	FUNC_SDD1_SDU1_ON				0x1000	///2��һ��ǿ���ź���Ч��־

//���� p.fan_mode ��λ����
#define	FAN_AUTOMATIC		0x01		//�Զ�ģʽ
#define	FAN_FIRE					0x02		//����״̬�·��Ȳ�����

//���� p.ups_direction_mode ��λ����
#define	UPS_DIR_SEL		0x01		//ѡ���Ƶ���ķ���
#define	UPS_NO_TIME	0x02		//��Ԯʱ���������ʱ��
#define	UPS_ALARM		0x04		//��Ԯʱ�������������
#define	UPS_RETURN		0x08		//��Ԯ���˳�ѡ��(0: ����ͣ���˳���1: ����ͣ���˳�)

//���� p.cooperate_sel1 ��λ����
#define	COOP_ARRIVE_NIGHTGONG	0x01
#define	COOP_DIVING_NOTIME			0x02
#define	COOP_DIVING_GONG				0x04
#define	COOP_INSP_RETURN				0x10
#define	COOP_THROUGH_DOOR			0x20

//���� p.landingcall_push ��λ����
...
//���� p.normal_cc_advanced ��λ����
#define	VIPRUN_CARCALL_ENABLE		0x01

//���� p.firealarm_function ��λ����
...
struct Parameter
{
	BYTE ucmp_enable;
	BYTE back32;
	BYTE emp_power_door;		///0: ������  1: ����1  2: ����2   3: ����1����2
	BYTE custumer1;				//�û����ܵ�ѡ��ģʽ
	BYTE bot_floor;	// bottom floor (0 - 62)
	BYTE top_floor;	// top floor (1 - 63)

	BYTE back3;			//�ֶ��룬���� 2byte, һ�� 6byte
	BYTE back4;
	BYTE back5;
	...
	BYTE fireman_function1;
			//	bit0: 1-->������վ��������������    									0-->������վ�����Զ���
			//bit1: 1-->������ I �׶Σ����ٹ��� 										0-->������ I �׶Σ���������
			//bit2: 1-->������ II �׶Σ����ٹ��� 									0-->������ II �׶Σ���������
			//bit3: 1-->����Ա�ź������󣬵����Զ��ط�������վ   			0-->���Զ�����Ҫ��Ϊ����
			//bit4: 1-->�ﵽ������վ�ſ����˳�����״̬(bit3=0)   			0-->����Ҫ����������վ�Ϳ����˳�
			//bit5: 1-->fire call �ź��Զ���������Ա(Ҳ�����Զ��˳�)		0-->��Ҫ����Ա����
	...
	BYTE cooperate_sel1;		//���ݹ���ѡ��
	BYTE arrivegong_starttime;
	BYTE cooperate_sel2;		//���ݹ���ѡ��
			//bit0--bit7: ����
	...
	BYTE back31;
	WORD brake_check_time;		//��բ���Զ�����ʱ��(ǧλ��λ: Сʱ     ʮλ��λ: ����)
	BYTE back21;
	BYTE lcd_backlight;		//LCD����ı������
	BYTE loadtype;
	BYTE arrowtype;
	BYTE back29;

	BYTE back12;			//������վ������ѡ��
	WORD adlimit[C_LOADTYPE_CNT];			// ģ�������ؼ�¼��ADֵ
	BYTE back24;

	BYTE brake_check_cycle;				//��բ���Զ���������(����Ϊ��λ:1-31��)
	WORD back25;
	WORD back26;
	WORD back27;
	BYTE antifainttime;
	...
	WORD F5_X7;
	WORD F5_X8;
	BYTE fx_active;							// �Ƿ�ʹ�ܷ��ǹ���

	BYTE back8;
	WORD fx_offtime;							// �Ͽ����нӴ������պϷ���֮����ӳ�ʱ��
	WORD fx_ontime;							// �Ͽ��������պ����нӴ���֮����ӳ�ʱ��

	BYTE back23;
	BYTE door_connect;				//���������ӷ�ʽ(1: �·�ʽ(������ǰ�������ں�); 0: �ɷ�ʽ(������ǰ�������ں�))
	...
	BYTE lift_func_sel1;			//���ݹ���ѡ��
	BYTE back17;
	BYTE evac_door;								//�������������ű���״̬(0: ����  1: ����)
	BYTE evac_fire_carlightmode;		//����������Լ��𾯳�����������ģʽ: 0-->2�ַ�ʽ������ 1-->���������ص� 2-->�𾯳���ص� 3-->2�ַ�ʽ���ص�
	BYTE ups_direction_mode;			//UPS ���ܲ���
	BYTE back28;
	BYTE fve_ex_inpar [3][MAX_IO_TYPE];
	BYTE hse_ex_inpar [5][MAX_IO_TYPE];			//Mcu ��չ�������(һ��3����Ԥ��2��)
	BYTE hse_ex_outpar [4][MAX_IO_TYPE];			//Mcu ��չ������(һ��2����Ԥ��2��)
...
extern DWORD tripcount;							// �г̼���
extern DWORD op_time;							// ����ʱ��

extern BYTE testtrip;							// ��������
...
extern BYTE doorstoppush_sheopen_flag;		//���ű�־
extern BYTE doorstoppush_sheclose_flag;		//�����ű�־
extern BYTE she_photonsensor;
extern BYTE she_calldoor_double;
extern BYTE she_calldir;		//����ʱ��ͨ�ŵĴ���
...
#define NOT_AVAILABLE		0x80	// state not available  ����Ϊ2S
...
#define ESE_HBCHK_TIMER			(15*2)		//����֮�� 5S ����������
...
extern BYTE bFx_check_enable;			///0: ȡ�����ǹ���		1: �����ǹ���
extern BYTE bTemp_check_enable;			///0: ȡ�����ƹ��¶ȼ��		1: �����ƹ��¶�
extern BYTE bTestDL;
extern BYTE bTest_SIL;
extern BYTE	forced_stop;
extern BYTE bTest_brake;					///1: ���Ա�բ��
extern BYTE brake_value;					//���Ա�բ���Ľ���: 1: �ϸ�    2: ���ϸ�
...
extern WORD floor_higth[MAX_FLOOR];	//¥��
...
#define	CANB_HEARTBEAT_NOTREAD		72000		///2 Сʱ��¼һ��CANB������
