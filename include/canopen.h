...
//*******************************************************************************
//CAN_A
#define	HSE_ID					0x01		// node id HSE	/* main board */
#define	DCU_ID					0x02		// node id DCU	
#define	SAF_ID					0x03		/* node id Safety circuit (SGM)						*/
#define	PSE_ID					0x04		// node id PSE
#define	EXE_ID					0x05		// node id of 1. EXT board, total 4 pcs 0x05~0x08		 /* G850 board */
...
#define	DSE_ID					0x09		// node id DSE				/* HHT */
...
#define	RFID_COP_ID1				0x33		// node id of SPEECH
#define	RFID_COP_ID2				0x34		// node id of SPEECH
#define	SPEECH_ID						0x35		// node id of SPEECH
#define	COP_DISPLAY_ID			0x50		// node id of SPEECH
#define	RFID_LIOP_ID				0x60		// node id of SPEECH
#define	LIOP_DISPLAY_ID			0x80		// node id of SPEECH
...
#define	LIFT_FUNCTION_SEL2	0x2528
#define	COOPERATE_FUNC2	0x2529
#define	MAX_ACCESS_NUM	0x252A
...
#define	E_STEEL_BROKE		0x8173
#define	E_HEARTBEAT_ACCESS		0x817F
