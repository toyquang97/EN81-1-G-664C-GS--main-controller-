...
#define EE_BLOCK_SIZE		128			// EEPROM page size
#define EE_CAP_KB		64ul		// EEPROM capacity
#define EE_1K_SIZE		1024ul

//#define	TEST_EEPROM

//-----------Participants checksum calculation of the following content, please do not modify at will---------------------
#define EE_PARAMETER		0x0000ul
#define EE_CHECKSUM		(EE_PARAMETER+sizeof(p))
//-----------Participants checksum calculation of the above content, please do not modify at will---------------------
